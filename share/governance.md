...
* [ ] In the [organisation settings](https://github.com/orgs/voxpupuli/people?query=role%3Aowner) and [enterprise settings](https://github.com/enterprises/voxpupuli/admins), set former PMC members from `Owner` to `Member`, update new PMC members to `Owner`
* [ ] Make org membership public
    * [ ] Afterwards apply for [the GitHub maintainers community](https://maintainers.github.com/auth/signin)
* [ ] Apply for community org access (will be verified via github org membership to vox pupuli)
